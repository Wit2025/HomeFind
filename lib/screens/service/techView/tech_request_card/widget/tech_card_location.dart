...
class TechRequestCardLocation extends StatelessWidget {
  ...
  const TechRequestCardLocation({super.key, required this.request});
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
        color: AppColors.color1.withValues(alpha: 0.05),
        borderRadius: BorderRadius.circular(12),
        border: Border.all(color: AppColors.color1.withValues(alpha: 0.1)),
      ),
      child: Row(
