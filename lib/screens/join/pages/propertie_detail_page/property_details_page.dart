...
import 'package:homefind/screens/join/pages/propertie_detail_page/widget/property_app_bar.dart';
...
class _PropertyDetailsPageState extends State<PropertyDetailsPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Column(
        children: [
          PropertyProgressIndicator(primaryColor: _primaryColor),
          Expanded(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    PropertyMainImageSection(
                      ...
                      onPickImage: () => PropertyImageService.pickMainImage(context, _controller),
                      onRemoveImage: _controller.removeMainImage,
                    ),
                    const SizedBox(height: 14),
                    PropertyImagesSection(
                      primaryColor: _primaryColor,
                      selectedPropertyImages: _controller.selectedPropertyImages,
                      onPickImages: () => PropertyImageService.pickPropertyImages(context, _controller),
